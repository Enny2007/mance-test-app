...
const faqs = [
  {
    question: "What Plan Fits Government",
    answer:
  ...
  return (
    <section className="relative mx-auto max-w-3xl px-4 py-20">
      ...
      <div className="text-center">
        <h2 className="mb-3 text-center text-3xl font-semibold text-gray-900">
          Frequently Asked Questions
        </h2>
        <p className="items-center text-sm text-gray-500 text-center mx-auto md:mx-30 mb-10 ">
          Have questions about how Mance works or how it can fit your
          organization? Explore answers to the most common queries from teams
          and leaders{" "}
        </p>
      </div>
